...
$.fn.Huploadify = function(opts){
	...
	this.each(function(){
		...
		inputStr += '"/>';
		inputStr += '<a id="file_upload_' + instanceNumber + '-button" href="javascript:void(0)" class="wxvet-uploadify-button ' + option.buttonClass + '">';
	  ...
	  var fileObj = {
		  ...
		  init: function() {	  
			  ...
			  _this.find('.wxvet-uploadify-button').on('click',function(){
